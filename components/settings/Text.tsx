...
const Text = ({
  ...
  <div className='flex flex-col gap-3 border-b border-primary-grey-50 px-5 py-3'>
...
const RenderSelect = ({
  ...
  >
    <SelectTrigger className='no-ring w-full rounded-lg border border-primary-grey-50'>
      <SelectValue
        placeholder={
          config.property === "fontFamily"
            ? "Choose a font"
